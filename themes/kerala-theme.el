...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(link ((,class (:foreground ,linkcol :underline t))))
   `(org-code ((,class (:foreground ,fg2))))
   `(org-hide ((,class (:foreground ,fg4))))
   `(org-level-1 ((,class (:bold t :foreground ,level1 :height 1.7))))
   `(org-level-2 ((,class (:bold t :foreground ,level2 :height 1.6))))
   `(org-level-3 ((,class (:bold t :foreground ,level3 :height 1.5))))
   `(org-level-4 ((,class (:bold t :foreground ,level4 :height 1.4))))
   `(org-level-5 ((,class (:bold t :foreground ,level5 :height 1.3))))
   `(org-level-6 ((,class (:bold t :foreground ,level6 :height 1.2))))
   `(org-level-7 ((,class (:bold t :foreground ,level7 :height 1.1))))
   `(org-level-8 ((,class (:bold t :foreground ,level8 :height 1.0))))
   `(org-date ((,class (:underline t :foreground ,var) )))
   `(org-footnote  ((,class (:underline t :foreground ,fg4))))
   `(org-link ((,class (:underline t :foreground ,linkcol ))))
   `(org-special-keyword ((,class (:foreground ,func))))
   `(org-block ((,class (:foreground ,fg2 :background,bg5))))
   `(org-block-begin-line ((,class (:inherit org-block :slant italic))))
   `(org-block-end-line ((,class (:inherit org-block :slant italic))))
   ...
   `(rainbow-delimiters-depth-1-face ((,class :foreground ,level1)))
   `(rainbow-delimiters-depth-2-face ((,class :foreground ,level2)))
   `(rainbow-delimiters-depth-3-face ((,class :foreground ,level3)))
   `(rainbow-delimiters-depth-4-face ((,class :foreground ,level4)))
   `(rainbow-delimiters-depth-5-face ((,class :foreground ,level5)))
   `(rainbow-delimiters-depth-6-face ((,class :foreground ,level6)))
   `(rainbow-delimiters-depth-7-face ((,class :foreground ,level7)))
   `(rainbow-delimiters-depth-8-face ((,class :foreground ,level8)))
   ...
   (when (>= emacs-major-version 26)
     (custom-theme-set-faces
      ...
      `(line-number-current-line ((t (:inherit fringe :foreground ,fg5 :weight bold))))))
...
(provide-theme 'kerala)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; kerala-theme.el ends here
